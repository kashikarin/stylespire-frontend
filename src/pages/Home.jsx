...
export function Home(){
    ...
    return(
        <div className="max-h-[calc(100vh-80px)] overflow-y-auto [&::-webkit-scrollbar]:hidden flex items-center py-2 narrow:py-4 px-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 normal:grid-cols-2 gap-8 narrow:gap-12 normal:gap-16 items-center">
                ...
                <div className="flex flex-col gap-4 narrow:gap-6">
                    ...
                    <h1 
                        className="
                            text-3xl narrow:text-4xl normal:text-5xl wide:text-6xl font-bold 
                            text-primary-dark 
                            leading-tight
                        "
                    >
                    ...
                    {!isTablet && (
                        <div className="flex gap-6 narrow:gap-8 pt-2 narrow:pt-4">
                            ...
                            <div className='min-h-[72px]'>
                                <div className="text-2xl narrow:text-3xl font-bold text-primary-dark">AI-Guided Curation</div>
                                <div className="text-xs narrow:text-sm uppercase tracking-[0.12em] text-primary-dark/60">Preference-Driven</div>
                            </div>
                            <div className='min-h-[72px]'>
                                <div className="text-2xl narrow:text-3xl font-bold text-primary-dark">Persistent Favorites</div>
                                <div className="text-xs narrow:text-sm uppercase tracking-[0.12em] text-primary-dark/60">Always Available</div>
                            </div>
                            <div className='min-h-[72px]'>
                                <div className="text-2xl narrow:text-3xl font-bold text-primary-dark">Canvas-Based Styleboards</div>
                                <div className="text-xs narrow:text-sm uppercase tracking-[0.12em] text-primary-dark/60">Fully Editable</div>
                            </div>
                        </div>
                    )}
                </div>
